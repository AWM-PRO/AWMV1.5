...
def logo2():
 ...
 | |\  | |___ /  \  | |    | |_) | |___ / ___ \| |_| | |___
 |_| \_|_____/_/\_\ |_|    |____/|_____/_/   \_\____/|_____|
 login success {kk}user{P}, script by {kk} mirwais danishyar{P} version 1.5""")
...
def menu(n,t,c):
	...
	print(f" [{hh}02{P}] CRACK UID         [{hh}08{P}] CRACK FILE CLONE")
...
def crack_group():
	link = input(f' [{hh}<{P}] pest id public for hack \n id group : ')
